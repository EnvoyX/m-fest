export const events = [
    {
        ...
        img: "/events/card/mcare.png",
        logo: "/events/mcare-icon.svg",
        href: "/events/m-care",
    },
    {
        title: "M-Run",
