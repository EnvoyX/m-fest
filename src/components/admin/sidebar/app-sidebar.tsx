...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  return (
    <Sidebar
      ...
      {...props}
      className="bg-transparent backdrop-glass-lg border-r-1"
      variant="floating"
    >
      <SidebarHeader className="bg-transparent backdrop-glass-3xl">
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton
              asChild
      ...
      <SidebarContent className="bg-transparent backdrop-glass-3xl ">
        <NavMain items={dataNavSidebar.navMain} />
      </SidebarContent>
      <SidebarFooter className="bg-transparent backdrop-glass-3xl">
        <NavUser />
      </SidebarFooter>
    </Sidebar>
  );
