            ...
            <BlurFade inView delay={0.5}>
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div className="bg-trasnparent backdrop-blur-lg rounded-lg  p-8 text-white">
                            <h3 className="text-2xl font-bold mb-4">
                                Contact Information
                            </h3>
                            <p className="text-purple-100 mb-8">
                                For any further questions and informations, you
                                can contact our contact person below here.
                            </p>
                        ...
                        <div>
                            <h3 className="text-3xl font-bold text-primary mb-2 flex gap-4 items-center">
                                <FaMapLocation />{" "}
                                <span>Our Location on Maps</span>
                            </h3>
                            <p className="text-lg text-white mb-6">
                                Check our location on Google Maps to help you
                                find our location.
                            </p>
