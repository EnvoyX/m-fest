                ...
                >
                    ...
                    <CardFooter className="flex justify-center mt-auto">
                        {comp.compOpenCase || comp.examOpen ? (
                            <CountdownClient
                                date={comp.compOpenCase || (comp.examOpen as Date)}
                                registeredCompetition={
                                    registeredCompetition as CompRegistration
                                }
                                user={user as User}
                                comp={comp as Competition}
                                description={
                                    comp.compOpenCase ? "Case opened in" : "Exam starts in"
                                }
                                type={comp.compOpenCase ? "compOpenCase" : "examOpen"}
                                team={team as Team}
                            />
                        ) : (
                            <Button
                                ...
                                disabled={
                                    comp.abbreviation === "STEM" && isExamOpen
                                        ? false
                                        : comp.abbreviation === "STEM" && !isExamOpen ? true : team?.leaderUserId === user.id
                            ...
                            >
                                <Link
                                    href={
                                        comp.abbreviation === "STEM" && isExamOpen
                                            ? `/dashboard/competitions/${registeredCompetition.id}`
                                            : comp.abbreviation === "STEM" && !isExamOpen ? `` : team?.leaderUserId === user.id
                                                ? team?.teamStatus === "ACCEPTED"
                                                    ? `/dashboard/competitions/${registeredCompetition.id}`
                                                    : ``
                                                : ``
                                ...
                                >
                                    <span>
                                        {comp.abbreviation === "STEM" && isExamOpen
                                            ? "Enter Exam"
                                            : comp.abbreviation === "STEM" && !isExamOpen ? "Exam closed" : team?.leaderUserId === user.id
                                                ? team?.teamStatus === "ACCEPTED"
                                                    ? "View Details"
