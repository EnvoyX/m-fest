...
export default function SubmitForm({
    ...
    leaderUserId: string;
    type?: "full-paper" | "preliminary" | "pitch-deck";
}) {
    ...
    const { startUpload: startUploadBCC } = useUploadThing("submitFileBCC", {
        onBeforeUploadBegin(files) {
            return files;
        },
        onUploadBegin: (filename: string) => {
     ...
     const { startUpload: startUploadIPPC } = useUploadThing("submitFileIPPC", {
        onBeforeUploadBegin(files) {
            return files;
        },
        onUploadBegin: (filename: string) => {
                ...
                <div className="flex items-center justify-center">
                    <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm p-6">
                        <div className="mb-6">
                            ...
                            {!userRegisteredComp?.submissionFileSubmitted2 ? (
                                <>
                        ...
                        {!fileName && !userRegisteredComp?.submissionFileSubmitted2 && (
                            <div
                                {...getRootProps()}
                                className={cn(
                                ...
                                <div className="text-center">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-blue-600 dark:text-blue-400 font-semibold line-clamp-1">
                                            {userRegisteredComp?.submissionFileName2}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        {userRegisteredComp?.submissionFileSubmitted2 && (
                            <p className="text-sm text-green-500 mt-2 text-center">
                                {`Submitted on ${userRegisteredComp.submissionFileCreatedAt2
                                    ? format(
                                        new Date(userRegisteredComp.submissionFileCreatedAt2),
        ...
        <section>
            ...
            <div className="flex items-center justify-center">
                <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm p-6">
                    ...
                    {userRegisteredComp?.submissionFileSubmitted && (
                        <p className="text-sm text-green-500 mt-2 text-center">
                            {`Submitted on ${userRegisteredComp.submissionFileCreatedAt
                                ? format(
