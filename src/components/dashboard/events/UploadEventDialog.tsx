...
import {
    type UploadEventProps,
    type UploadThingEventRoute,
} from "@/types/types";
...
export default function UploadEventDialog({
    id,
    title,
    isLoading,
    setIsLoading,
    ...
    const [uploadThingRouteUpload, setUploadThingRouteUpload] =
        useState<UploadThingEventRoute | null>(null);
                    ...
                    <Button
                        ...
                        onClick={() => {
                            setUploadThingRouteUpload(
                                uploadThingRoute as UploadThingEventRoute,
                            );
                    ...
                    <div className="grid gap-4">
                        {!isUploading && (
                            <div {...getRootProps()} className="group outline-none">
                                ...
                                >
                                    <div className="absolute inset-0 bg-linear-to-b from-transparent to-slate-100/20 dark:to-slate-800/20 pointer-events-none" />
                                    ...
                                    <div className="relative flex flex-col items-center text-center">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-sm text-slate-500 dark:text-slate-400 max-w-60">
                                                {"Max 4MB • Max 1 File • PDF, Image"}{" "}
                                            </p>

                                            {files[0]?.name && (
                                                <div className="mt-4 px-3 py-1.5 bg-blue-50 dark:bg-blue-900/30 border border-blue-100 dark:border-blue-800 rounded-md">
                                                    <p className="text-xs font-medium text-blue-700 dark:text-blue-300 truncate max-w-50">
                                                        {files[0].name}
                                                    </p>
                                                </div>
                                            )}
