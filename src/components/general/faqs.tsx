    ...
    const faqItems = [
        {
            ...
            answer: "For college students, the Business Case, Innovative Poster and Paper, and Pipeline Design competitions are open. For high school students, the Science, Technology, Engineering, or Mathematics (STEM) competition is open.",
        },
        {
            id: "item-2",
            question:
                "Do participants need to be from the same institution or school?",
            answer: "Yes, for each competition, participants must be from the same institution or school.",
        },
        {
            id: "item-3",
            question: "Where will the competition be held?",
            answer: "The selection phase will be conducted online, while finalists will compete offline at ITB Ganesha.",
        },
        {
            id: "item-4",
        ...
        },
        {
            ...
            answer: "One person is only allowed to participate in 1 competition category in M-Fest 2026.",
        },
        {
            id: "item-6",
            question: "Competition related questions?",
            answer: "If you have any further questions regarding our competitions, please kindly follow our Instagram and click 'FAQ Competitions' highlight or contact our contact person. Thank you!",
        },
    ];
                    ...
                    <div className="mx-auto max-w-9xl text-center">
                        ...
                        <div className="mx-auto max-w-2xl text-center">
                            <p className="text-semibold mt-4 text-2xl">
                                Discover quick and comprehensive answers to
                            ...
                            <Dialog>
                                ...
                                <DialogContent className="sm:max-w-md bg-transparent backdrop-blur-lg">
                                    <DialogHeader>
                                        ...
                                        <DialogDescription>
                                            Please kindly contact our contact
