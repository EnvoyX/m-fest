...
export default function FooterSection() {
  return (
    <footer className="mask-t-from-80% lg:mask-t-from-90% lg:mask-t-to-100% min-h-screen relative">
      ...
      <div className="mx-auto max-w-5xl px-6 absolute max-sm:bottom-42 bottom-64 left-0 right-0">
        <Link
          href="/"
          aria-label="go home"
        ...
        <div className="mx-auto mt-5 mb-5 flex max-sm:flex-col w-fit items-center justify-center rounded-full max-sm:rounded-lg border border-white bg-transparent py-3 px-8 text-white backdrop-glass-sm transition-colors hover:bg-white/10">
          <Link
        ...
        <span className="text-accent-foreground text-center text-sm flex flex-col">
          {" "}
          © {getCurrentDate().getFullYear()} Mechanical Festival 2026, All
          rights reserved.{" "}
          <span>
            {" "}
