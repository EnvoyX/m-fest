  ...
  return (
    <footer className="mask-t-from-80% lg:mask-t-from-90% lg:mask-t-to-100% min-h-screen relative py-16 md:py-32 ">
      ...
      <div className="mx-auto max-w-5xl px-6 absolute bottom-64 left-0 right-0">
        ...
        <div className="mx-auto my-10 flex w-full md:w-fit items-center justify-center rounded-full border border-white bg-transparent py-3 px-8 text-white backdrop-glass-sm transition-colors hover:bg-white/10">
          <Link
        ...
        <span className="text-accent-foreground text-center text-sm flex flex-col">
          {" "}
          © {new Date().getFullYear()} Mechanical Festival 2026, All rights
          reserved.{" "}
          <span>
            {" "}
