          ...
          >
            <div key={1} className="w-full md:w-auto">
              <Button
                asChild
                size="lg"
                className="drop-shadow-xl/50 w-full md:w-72 group relative overflow-hidden bg-slate-900/30 hover:bg-slate-800/50 backdrop-glass-md border border-white/20 text-white rounded-xl px-6 py-6 text-lg transition-all duration-300 shadow-[0_0_20px_rgba(0,0,0,0.1)] hover:shadow-[0_0_20px_rgba(34,211,238,0.2)]"
              >
                <Link
                  href="/events"
