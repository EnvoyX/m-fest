...
export default function EventSection() {
    return (
        <section className="py-24 px-6 md:py-40 md:px-12 lg:px-24">
            ...
            <div className="mx-auto w-fit grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6  gap-6 md:gap-12 lg:gap-16 mt-10 md:mt-20">
