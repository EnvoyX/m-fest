  ...
  return (
    <div className="flex flex-wrap justify-center items-end gap-2 md:gap-4">
      ...
      <div className="flex flex-col items-center">
        {/* Mobile: w-16 h-20, Desktop: w-24 h-32 */}
  ...
  return (
    ...
    <div className="min-h-screen text-white">
      <div className="container mx-auto px-4 py-8 md:px-12 md:py-16 flex flex-col items-center text-center md:text-left">
        ...
        {/* Responsive Image: w-full, max-w-4xl, auto height */}
        <img
        ...
        {/* Intro Text */}
        <div className="max-w-3xl mx-auto space-y-6 my-10 text-base md:text-xl leading-relaxed text-gray-200">
          <p>
        ...
        <div className="w-full max-w-4xl mx-auto text-left">
          ...
          <h2 className="text-3xl md:text-6xl font-bold mb-10 text-center tracking-tight">
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-5 md:pl-6 space-y-4 text-gray-300 text-base md:text-lg leading-relaxed">
              <li>
              ...
              <li>
                Peserta Motor Matic maupun Motor Manual <span className="font-semibold text-white">DIHARAPKAN</span> datang pada pukul 07:30 - 12:00 untuk registrasi ulang pada tenda pendaftaran, apabila melewati batas waktu yang telah ditentukan, akan hangus kesempatan untuk mengikuti acara.
              </li>
            </ul>
          </section>
        ...
        <div className="text-center w-full mt-8 md:mt-16">
          <div className="text-3xl md:text-5xl font-bold mb-8 tracking-tight">
            No need to worry, We'll fix them right.
          </div>

          <div className="p-6 rounded-xl inline-block mb-8">
            <span className="font-bold text-3xl md:text-5xl">Registration</span><br/>
            <span className="font-bold text-lg md:text-2xl block mt-2">14-28 February 2026</span>
          ...
          <div>
            <Button
                ...
                variant="secondary"
                size="lg"
                className="rounded-xl text-base md:text-lg font-bold px-8 py-6 md:px-10 md:py-8 shadow-lg hover:scale-105 transition-transform"
            >
