...
import MExpoForm from "@/components/dashboard/events/M-Expo-form";
...
async function FetchEventForm({
    ...
    const isMExpoOpen = isEventOpen(
        eventsList.find((e) => e.id === "M-EXPO") as Event,
        currentDate,
    );
