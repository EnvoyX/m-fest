  ...
  return (
    <>
      <div className="flex justify-between mt-4">
        <h3 className="text-3xl font-bold text-foreground">Your Team</h3>
        <Button
          className={cn("cursor-pointer", {
            "opacity-50 cursor-not-allowed pointer-events-none": isTeamExist,
          })}
          disabled={isTeamExist}
          asChild
        >
          <Link href={isTeamExist ? "team" : "team/create-team"} prefetch>
            Create team
          </Link>
        </Button>
      </div>
