...
export default async function EntryExamPage() {
    ...
    await db.examSession.create({
        data: {
            ...
            token,
            expiresAt: new Date(getCurrentDate() + 1000 * 60 * 60 * 3), // 3 hours
        },
    });
    return (
        <div className="flex flex-col items-center justify-center h-screen">
            ...
            <p className="text-lg font-bold">
                Closed Book Exam & Cheating is prohibited, you will be
                disqualified if caught.
            </p>
            <Button
                variant="primary"
                className={
                    "rounded-sm bg-white/5 border hover:bg-white/10 mt-2"
                }
            >
